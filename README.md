...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/607f63699861f80016387fac
...
To start editing your site, you can use the Sanity interface at https://violet-birch-f6369.sanity.studio/.
...
Generated at `2021-04-20T23:28:29.352Z` by Stackbit version `0.3.50`.